...
class UniformNoiseFactory(BaseDatasetFactory):
    ...
    def _get_iterator(self, num_samples: int, classes: List[int], hypercube: List[Tuple[int, int]], seed: int = 1):
...
if __name__ == "__main__":
    ...
    classes = [0, 1]
    hypercube = [(-1, 1), (3, 6)]
    config = {"seed": 1, "classes": classes, "num_samples": [2000, 2000], "hypercube": hypercube}
